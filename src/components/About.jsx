    ...
    <section id="about" className="section">
      <div className="container">
        ...
        <p className="text-center mb-2 wow fadeInUp">
          <span className="bg-primary text-dark px-2">Summary</span>
        </p>
        ...
        <div className="row">
          <div className="col-lg-8 text-center text-lg-start wow fadeInUp">
            ...
            <p className="text-5">
              ...
              applications. I enjoy developing scalable, robust and clean web
              applications that provide real value and a pleasant experience to
              the end user. I also provide business consulting, web development
              services, content creation and curation for businesses.
            </p>
          </div>
          <div
        ...
        <div className="row gy-3 mt-4">
          <div className="col-6 col-lg-3 wow fadeInUp">
            ...
            <p className="text-4 text-dark fw-600 mb-0">Scott Tarnowsky</p>
          </div>
          ...
          <div className="col-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
            ...
            <p className="text-4 text-dark fw-600 mb-0">
              Originally: Detroit, USA
            </p>
            <p className="text-4 text-dark fw-600 mb-0">
              Currently: New York, USA
            </p>
          </div>
        </div>
      </div>
